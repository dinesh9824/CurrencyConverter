...
class currency_converter:
    ...
    def currency():
        ...
        if input_of_from==1 and input_of_to==2:
            print(f'The amount from Indian rupee to US dollar is {amount/82} USD')
        
        elif input_of_from==2 and input_of_to==1:
            print(f'The amount from US dollar to Indian rupee is {amount*82} rupee')
            ...
            print(f'The amount from US dollar to New Zealand dollar is {amount*0.63} NZD')
        
        elif input_of_from==3 and input_of_to==2:
            print(f'The amount from NZD to USD is {amount/0.63} USD')
